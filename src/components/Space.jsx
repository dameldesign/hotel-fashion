...
const Space = () => {
  return (
    <section className=" flex flex-col items-center gap-16 justify-between text-[--text-color] mx-auto p-6 ">
      <h1 className=" text-[--text-color] font-medium text-[32px] leading-[48px] md:mb-6 text-start lg:px-0 ">
